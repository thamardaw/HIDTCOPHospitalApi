...
class InventoryProtocol(Protocol):
    ...
    def listSmallInventoryItems(self) -> List[InventoryItemDTO]:
        ...

    def listSmallPharmacyItems(self) -> List[PharmacyItemDTO]:
        ...

    def listSmallInventoryTransactions(self) -> List[InventoryTransactionDTO]:
        ...

    def listSmallInventoryTransactionsByNoteLikeAndType(self,note: str,type) -> List[InventoryTransactionDTO]:
        ...

    def listSmallTransactionTypes(self) -> List[TransactionTypeDTO]:
        ...
